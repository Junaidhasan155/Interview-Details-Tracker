    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-7xl w-[95vw] max-h-[95vh] overflow-y-auto p-0">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-6 px-6 pb-6">
          ...
          {/* Overview Tab */}
          <TabsContent value="overview" className="space-y-6 mt-6 max-h-[60vh] overflow-y-auto pr-2">
          ...
          {/* Culture Tab */}
          <TabsContent value="culture" className="space-y-6 mt-6 max-h-[60vh] overflow-y-auto pr-2">
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <CardTitle className="text-xl flex items-center gap-2">
